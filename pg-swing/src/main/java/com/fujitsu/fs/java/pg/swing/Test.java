...
public class Test extends JFrame {
    ...
    public Test() {
        ...
        JComboBox comboBox = new JComboBox(
                new String[] { "These", "Are", "Different", "Selections" });

        // the weights the component should have in concern to them being added
        // to a container that is larger
        ...
        // the way the component should expand in size if it is placed in a
        // container that is larger
        // than its preferred size
        c.fill = GridBagConstraints.HORIZONTAL;

        contentPanel.add(button1, c);

        // reuse the GridBagContraint, no need to instantiate one for each
        // component
        c.gridy = 1;
